...
### Bejeweled
- [x] Step1: 背景調査完了 — 参考URL: note.com (Bejeweled 和訳)
- [x] Step2: 全行照合完了 — 問題箇所: 45件（A:15 B:2 C:3 D:25）
- [x] Step3: 修正適用 — 修正: 45行 / 修正不要: 16行
- [x] Step4: チェックリスト記録

### Karma
- [x] Step1: 背景調査完了 — 参考URL: note.com / ameblo.jp (Karma 和訳)
- [x] Step2: 全行照合完了 — 問題箇所: 31件（A:5 B:2 C:1 D:23）
- [x] Step3: 修正適用 — 修正: 31行 / 修正不要: 23行
- [x] Step4: チェックリスト記録

### Mastermind
- [x] Step1: 背景調査完了 — 参考URL: ameblo.jp (Mastermind 和訳)
...
### Sweet Nothing
- [x] Step1: 背景調査完了 — 参考URL: ameblo.jp / note.com (Sweet Nothing 和訳)
- [x] Step2: 全行照合完了 — 問題箇所: 15件（A:3 B:0 C:2 D:10）
- [x] Step3: 修正適用 — 修正: 15行（sweet nothings誤訳「甘い無」→「愛の言葉/愛の囁き」、BRIDGE壊滅的MT修正）
- [x] Step4: チェックリスト記録

### Vigilante Shit
- [x] Step1: 背景調査完了 — 参考URL: ameblo.jp / note.com / youtube.com (Vigilante Shit 和訳)
- [x] Step2: 全行照合完了 — 問題箇所: 24件（A:10 B:2 C:2 D:10）
- [x] Step3: 修正適用 — 修正: 24行（壊滅的MT「私、始める、でも」→「自分からは仕掛けない」、未翻訳4箇所修正）
- [x] Step4: チェックリスト記録

### You're on Your Own, Kid
- [x] Step1: 背景調査完了 — 参考URL: ameblo.jp / note.com (YOYOK 和訳)
- [x] Step2: 全行照合完了 — 問題箇所: 10件（A:1 B:0 C:3 D:6）
- [x] Step3: 修正適用 — 修正: 10行（「お久しぶりです」→「さよなら」、敬体修正、友情ブレスレット行修正）
- [x] Step4: チェックリスト記録
...
### Robin
- [x] Step1: 背景調査完了 — 参考URL: note.com / youtube.com
- [x] Step2: 全行照合完了 — 問題箇所: 18件（A:6 C:2 D:4 E:6壊滅的MT未翻訳）
- [x] Step3: 修正適用 — 修正: 18行（壊滅的MT「クロックがテザリング」→「スローにした時計は繋ぎ止められている」、BRIDGE全行壊滅的MT修正、「For you→あなた」→「あなたのために」×3、敬体→常体）
- [x] Step4: チェックリスト記録

### Cassandra
- [x] Step1: 背景調査完了 — 参考URL: note.com
- [x] Step2: 全行照合完了 — 問題箇所: 36件（A:18 B:3 C:2 E:1未翻訳 D:12）
- [x] Step3: 修正適用 — 修正: 36行（壊滅的MT「だから、彼ら、彼女」→「だからカサンドラを最初に殺した」×3、「あなた、信じる、私を、今」→「今は信じてくれる？」×4、BRIDGE全行壊滅的MT修正、VERSE3全行修正、OUTRO修正）
- [x] Step4: チェックリスト記録
...
### exile
- [x] Step1: 背景調査完了 — 参考URL: lyricstranslate.com / seesaa.net / ameblo.jp
- [x] Step2: 全行照合完了 — 問題箇所: 10件（A:3構造破損 C:1敬体 D:6不完全訳）
- [x] Step3: 修正適用 — 修正: 10行（Bridge/Chorus/Outroセクションヘッダー歌詞混入を正規構造化、敬体修正、「兆候」→「サイン」統一、不完全訳修正）
- [x] Step4: チェックリスト記録
...
### seven
- [x] Step1: 背景調査完了 — 参考URL: ameblo.jp / note.com / hatenablog.com
- [x] Step2: 全行照合完了 — 問題箇所: 3件（A:2行ずれ D:1訳ずれ）
- [x] Step3: 修正適用 — 修正: 3行（「あの頃の私」→「叫びたい時にいつでも」、Chorus2行ずれ合体修正、「心が告げる」→「胸に誓う、誰にも言わない」）
- [x] Step4: チェックリスト記録
